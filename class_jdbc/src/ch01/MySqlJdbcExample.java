...
public class MySqlJdbcExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			resultSet = statement.executeQuery("SELECT * FROM tb_student"); // select 실행시 사용한다.
//			statement.executeUpdate(password); --> Insert, Update, delete 사용
			...
			while (resultSet.next()) {
				System.out.println("USER ID : " + resultSet.getInt("no"));
				System.out.println("USER NAME : " + resultSet.getString("name"));
				System.out.println("department : " + resultSet.getString("gender"));
